...
function GM:_InputMouseApply(cmd, x, y, ang)
	if MySelf:KeyDown(IN_WALK) and MySelf:IsHolding() then
		...
		RunConsoleCommand("_zs_rotateang", snapanglex, snapangley, snap)
		return true
	end
...
-- local fontfamily = "Undead"
local fontfamily = "DK Umbilical Noose"
...
function GM:Create3DFonts()
	local fontsizeadd3D = 2
	local fontweight3D = 2
